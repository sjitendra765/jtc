      ...
      this.setState(
        {
          ...
          exp_date:
            this.props.formdata.expiry_date &&
            moment(this.props.formdata.expiry_date).format('YYYY-MM-DD'),
          own_date:
            this.props.formdata.own_date &&
            moment(this.props.formdata.own_date).format('YYYY-MM-DD'),
        },
        () => {

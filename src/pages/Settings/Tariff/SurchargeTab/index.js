...
import SurchargeTabForm from './form';
...
class EnhancedUserTable extends React.Component {
  constructor(props, context) {
    ...
    this.state = {
      ...
      selected: [],
      data: [
        createData('Packing Kayu', 'Active'),
        createData('Barang Berbahaya', 'Active'),
        createData(' Binatang Hidup', 'Active'),
        createData('Human Remains', 'Active'),
      ],
      page: 0,
      rowsPerPage: 5,
    };
  ...
  //             return this.setState({ data: dataUsers })
  //         })

  // }

  componentDidMount() {
    // this.state.data.length === 0 && this.getBasetariffList()
  }
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <Grid md={12} item>
          {location.pathname !== '/settings/tariff/new-surcharge' ? (
            <div>

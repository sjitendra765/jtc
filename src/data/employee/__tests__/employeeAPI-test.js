...
describe('employeeAPI', () => {
  it('should request the correct data based on employee ID', async () => {
    ...
    let ConnoteAPI = createEmployeeAPI(customFetch);
    let result = await ConnoteAPI.getEmployeeDetail({employeeID});
  ...
  it('should request activity endpoint with the right params', async () => {
    ...
    let ConnoteAPI = createEmployeeAPI(customFetch);
    let result = await ConnoteAPI.getEmployeeActivities({...request});
